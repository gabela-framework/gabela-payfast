    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <div style="padding: 10em 10em; text-align: center;">
                <h2 class="alert alert-success" >Your Payment Was Successful!!</h2>
                <h4>Here is the link to download your product <a target="_blank"
                        href="https://manezaf8.co.za/music-shop/">Download Here...</a></h4>
                <br />
